...
| Segments | https://roaring-cocada-6272cb.netlify.app/segments | Demo ready | Platform/CRM segment sources, cached counts, usage map and sync health. | Confirm source ownership, cache cadence and acceptable freshness states. |
| Monitoring | https://roaring-cocada-6272cb.netlify.app/monitoring | Demo ready | Event queue, incidents, provider health and emergency actions. | Confirm incident severity, async queue visibility and auto-pause rules. |
