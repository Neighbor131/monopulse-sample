...
| Builder: Audience | https://roaring-cocada-6272cb.netlify.app/builder/audience | Demo ready | Audience segment and eligibility configuration. | Confirm segment rule model, exclusions and responsible-gaming gates. |
| Builder: Rewards | https://roaring-cocada-6272cb.netlify.app/builder/rewards | Demo ready | Reward selection, fulfillment mode and GUID/trigger handling. | Confirm operator wallet vs MonoPulse trigger ownership. |
